...
obj/main.o: src/main.cpp src/Core/Map/tmxParsing.h src/Core/Map/Layers/Layer.h src/Core/Map/Tileset.h src/Core/Map/Map.h src/Core/Map/Layers/MapLayer.h src/Core/Game.h
	$(COMPILATIONOBJ)
